...
parent._wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/getmathml.php';				// Specifies where is getmathml script
parent._wrs_conf_getlatexPath = '/pluginwiris_engine/app/getlatex';        // _wrs_conf_getlatexPath = '/pluginwiris_engine/app/getlatex';        // _wrs_conf_getlatexPath = '/pluginwiris_engine/app/getlatex';        // _wrs_conf_getlatexPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/getlatex.php';				// Specifies where is getlatex script
