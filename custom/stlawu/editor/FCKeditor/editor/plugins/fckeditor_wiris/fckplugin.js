...
parent._wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/editor.php';			// Specifies where is the editor HTML code (for popup window)
parent._wrs_conf_editorAttributes = 'width=500, height=400, scroll=no, resizable=yes';							// Specifies formula editor window options.
parent._wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/cas.php';					// Specifies where is the WIRIS cas HTML code (for popup window)
parent._wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';						// Specifies WIRIS cas window options

parent._wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/createimage.php';			// Specifies where is createimage script
parent._wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/createcasimage.php';	// Specifies where is createcasimage script

parent._wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/getmathml.php';				// Specifies where is getmathml script
parent._wrs_conf_getlatexPath = '/pluginwiris_engine/app/getlatex';        // _wrs_conf_getlatexPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/getlatex.php';				// Specifies where is getlatex script
