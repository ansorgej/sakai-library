            ...
            <div id="siteNav">
               <div id="linkNav">
                  ...
                  <div class="orientation">
                    Quicklinks: 
			<a href="/xsl-portal/site/039f69aa-f786-412b-933c-defe7eb3f4c1">Orientation to ECN</a> |
			<a href="http://library.walsh.edu/?quicklinks" target="_blank">Library Website</a>
                  </div>
                  <ul id="siteLinkList">
                     ...
                     <xsl:if test="1=1">
                        <li class="more-tab">
                           <a href="#" onclick="return dhtml_more_tabs();">
                              ...
                              <span class="outer"><span class="inner"><xsl:text>My Courses</xsl:text></span></span>
                           </a>
                        </li>
                     </xsl:if>
                 ...
                 <xsl:if test="@selected='true'">
                   <xsl:if test="viewAsStudentLink">
                     ...
                     <xsl:if test="viewAsStudentLink/roleSwitchState='true'">
                       <a id="roleSwitchAnchor"  style="color: #000">
                         <xsl:attribute name="href"><xsl:value-of select="viewAsStudentLink/switchRoleUrl" /></xsl:attribute>
...
<xsl:for-each select="categories/category" >
   ...
   <xsl:apply-templates select=".">
      <xsl:with-param name="content" select="'false'"/>
         ...
         <xsl:choose>
         <xsl:when test="(/portal/config/extra/logoSiteType = 'course') or (/portal/config/extra/logoSiteType = 'project')">
         <li><div class="toolSubMenuHolder help"><div class="toolSubMenuHolder_content">
               <div class="toolSubMenuHolder_tools">
               <ul id="toolSubMenu" class="toolSubMenu">
