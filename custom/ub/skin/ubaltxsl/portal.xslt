...
<div id="siteNavWrapper">
   ...
   <div id="mastHead">
      <div id="mastLogo">
	  <a href="http://www.sakaiproject.org/" target="_blank">
		<img src="/library/skin/ubaltxsl/images/sakailogo.gif" width="50" height="30" alt="Sakai" />
	  </a>
      </div>
      <div id="mastBanner">
	  <a href="http://www.ubonline.edu/" target="_blank">
		<img src="/library/skin/ubaltxsl/images/ub_online.gif" width="125" height="48" alt="UBOnline" />
	  </a>
      </div>
      <div id="mastLogin">
	<div id="ublogo">
	  <a href="http://www.ubalt.edu/inside/" target="_blank">
		<img src="/library/skin/ubaltxsl/images/ublogo.gif" alt="UB Logo" width="105" height="22" />
   	  </a>
	</div>
        <xsl:choose>
        ...
        <xsl:when test="loginInfo/topLogin != 'true'">
        		<div id="loginLinks">
			<a target="_parent">
			  <xsl:attribute name="href">/sakai-login-tool/container</xsl:attribute>
                          <xsl:attribute name="title">
