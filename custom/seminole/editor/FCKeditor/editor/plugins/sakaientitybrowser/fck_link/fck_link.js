...
function Ok()
{
	...
	// If no selection, no links are created
	...
	for ( var i = 0 ; i < aLinks.length ; i++ )
	{
		...
		if ( aHasSelection )
			...
			sInnerHtml = entityTitle ;		// use the entity title if no selection made
...
function BrowseServer()
{
	...
	// This makes the assumption that the current ImageBrowserURL contains the site id as the last
	// chucnk surrounded by '/' marks
	// TODO: replace with a new FCKConfig item, siteId that just contains the siteId... this will
	// require changing ALL of the renderers...
	var chunks = FCKConfig.ImageBrowserURL.split("/");
	OpenFileBrowser( "/sakai-entitybrowser-tool/faces/Browse?context="
		+ chunks[chunks.length-2], FCKConfig.LinkBrowserWindowWidth, FCKConfig.LinkBrowserWindowHeight ) ;
}
