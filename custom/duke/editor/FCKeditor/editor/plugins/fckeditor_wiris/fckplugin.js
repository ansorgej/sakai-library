...
parent._wrs_conf_CASEnabled = false;		// Specifies if WIRIS cas is enabled
...
parent._wrs_conf_editorPath = '/proxy/wiris/integration/editor.php';			// Specifies where is the editor HTML code (for popup window)
...
parent._wrs_conf_createimagePath = '/proxy/wiris/integration/createimage.php';			// Specifies where is createimage script
...
parent._wrs_conf_getmathmlPath = '/proxy/wiris/integration/getmathml.php';				// Specifies where is the getmathml script
parent._wrs_conf_servicePath = '/proxy/wiris/integration/service.php';					// Specifies where is the service script
