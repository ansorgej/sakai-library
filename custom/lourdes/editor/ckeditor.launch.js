...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
	...
	extraPlugins: (sakai.editor.enableResourceSearch ? 'resourcesearch,' : '')+'',
        ...
        [
            ...
            ['NumberedList','BulletedList','-','Outdent','Indent','Blockquote'],['Smiley','fmath_formula'],
            '/',
	    ...
	    ['atd-ckeditor'],
            ...
            (sakai.editor.enableResourceSearch
                ? ['ResourceSearch', 'Image','Flash','Table','HorizontalRule']
                : ['Image','Table']),
            '/',
            ['Format','Font','FontSize'],
            ['Maximize','Templates','Symbol','-','Source']
        ],
        toolbar: 'Full',
        resize_dir: 'both'
    };
