...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
   ...
   <head>
    ...
    <meta http-equiv="Content-Style-Type" content="text/css" />
      ...
      <script type="text/javascript" language="JavaScript" src="/kaltura/javascript/kaltura-display.js">
         <xsl:value-of select="' '"/>
      </script>
   </head>
   ...
   <div id="mastHead">
      ...
      <div id="mastLogin">
        ...
        <xsl:when test="currentUser">
           <div id="loginLinks">
		Hello, <xsl:value-of select="currentUser/first"/><xsl:text> | </xsl:text>
              <a target="_parent">
                 <xsl:attribute name="href">
