...
parent._wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/cas.php';					// Specifies where is the WIRIS cas HTML code (for popup window)
parent._wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';						// Specifies WIRIS cas window options

parent._wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/createimage.php';			// Specifies where is createimage script
parent._wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/createcasimage.php';		// Specifies where is createcasimage script

parent._wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/getmathml.php';				// Specifies where is the getmathml script
parent._wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = FCKConfig.PluginsPath + 'fckeditor_wiris/integration/service.php';					// Specifies where is the service script
...
parent._wrs_conf_enableAccessibility = false;
